...
export default function Footer() {
  return (
    <div className="w-screen  md:h-fit h-[20vh] bg-[#0f0f0f] relative overflow-hidden">

      <div className="w-screen  md:h-fit md:pb-[5vh] flex mobile-flex">
      <div className="md:w-1/3 mx-auto">
        ...
        <div className="md:w-1/3 mx-auto w-screen md:mt-0 mt-5">
          <img
            src={logo}
        ...
        <div className="w-1/3 text-gray-100 h-fit m-0 md:my-auto md:mt-[6vh] mobile-width mx-auto font-thin md:text-left  mt-3 text-center ">Copyright © Dyne Research 2024.<br className="md:hidden relative font-thin" /> All rights reserved.<br className=""/><span className="mobile font-thin"> Unauthorized replication prohibited.</span>
        </div>
      </div>
    </div>
  );
